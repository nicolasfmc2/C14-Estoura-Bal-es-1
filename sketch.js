...
var balaoazul, balaorosa, balaoverde
function preload(){
...
function blueBalloon() {
  ...
  balaoazul = createSprite(0,Math.round(random(20, 370)), 10, 10);
...
function greenBalloon() {
  ...
  balaoverde = createSprite(0,Math.round(random(20, 370)), 10, 10);
...
function pinkBalloon() {
  ...
  balaorosa = createSprite(0,Math.round(random(20, 370)), 10, 10);
